...
namespace AvaloniaThemeManager.Views
{
    ...
    public partial class NotificationDialog : Window
    {
        ...
        /// <summary>
        /// Gets or sets the type of the notification dialog.
        /// </summary>
        public NotificationDialogType DialogType { get; init; } = NotificationDialogType.Information;

        /// <summary>
        /// Gets or sets optional additional content displayed below the message body.
        /// </summary>
        public object? AdditionalContent { get; init; }
        ...
        private void UpdateContent()
        {
            ...
            AdditionalContentPresenter.Content = AdditionalContent;
        }
